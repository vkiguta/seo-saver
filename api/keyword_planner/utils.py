...
def google_suggestions_keywords(keyword, header):
    ...
    questions = ["what", "why", "why", "where", "how", "when", "who",
    "which", "who", "how"]

    prepositions = ["as", "without", "near", "around", "near", "with",
    "to", "similar", "close to", "next to", "or"]

    comparisons = ["for", "similar", "against", "vs", "and", "or"]
